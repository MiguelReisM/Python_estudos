...
- [Python 3 - Mundo 1: Fundamentos](https://www.cursoemvideo.com/curso/python-3-mundo-1/) ✅  
- [Python 3 - Mundo 2: Estruturas de Controle](https://www.cursoemvideo.com/curso/python-3-mundo-2/) ✅  
- [Python 3 - Mundo 3: Estruturas Compostas](https://www.cursoemvideo.com/curso/python-3-mundo-3/) ✅  

> Todos os 3 mundos concluídos com mais de **100 exercícios resolvidos** 🎉  
...
Clone o repositório:
```bash
git clone https://github.com/MiguelReisM/Python_estudos.git
cd Python_estudos
```
---
